...
define('port', default = 7777, type = int, help = 'app listen port')
...
define('admins', default = ("xuyanwei <xuyanwei@letv.com>",), help = 'admin email address')
...
define("moxi_manager_property",default=join(base_dir, "config","moxi_manager.property"), help="moxi manager config file")
...
define("moxi_service_cnf",default="/etc/moxi.conf",help="moxi configuration file")
...
define("start_moxi",default="service moxi start", help="start moxi")
define("stop_moxi",default="service moxi stop", help="stop moxi")
define("reload_moxi",default="service moxi reload", help="stop moxi")